...
import com.ms8.smartgaragedoor.FirebaseDatabaseFunctions.AUTO_CLOSE_WARNING
import com.ms8.smartgaragedoor.FirebaseDatabaseFunctions.STATUS_UPDATE
import com.ms8.smartgaragedoor.GarageBroadcastReceiver.Companion.ACTION_CLOSE_DOOR
import com.ms8.smartgaragedoor.GarageBroadcastReceiver.Companion.ACTION_OPEN_DOOR
    ...
    private fun handleAutoCloseWarning() {
        applicationContext.let { c ->
            ...
            val cancelAutoCloseIntent = Intent(c, GarageBroadcastReceiver::class.java).apply {
                action = GarageBroadcastReceiver.ACTION_CANCEL_AUTO_CLOSE
